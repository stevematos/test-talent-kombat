    ...
    (
        (
            ...
            [
                ...
                "Steve se mueve",
                "Test se mueve",
                "Test se mueve y le da un puñetazo",
                "Test se mueve y le da una patada",
                "Test le da una patada",
                "Test se mueve y le da una patada",
                "Empate",
            ],
        ),
...
@pytest.mark.parametrize(
    ...
    (
        ({"movimientos": ["DSD", "S"], "golpes": ["P", ""]}, None),
        ({"movimientos": ["DSD", "SSSSSS"], "golpes": ["P", ""]}, ActionExceedCharacters),
    ),
)
